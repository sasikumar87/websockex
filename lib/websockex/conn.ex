defmodule WebSockex.Conn do
  ...
  - `:socket_options` - extra options for TCP part of connection
  ...
  defp socket_connection_options(%{socket_options: nil}) do
    [
      mode: :binary,
      active: false,
      packet: 0
  ...
  defp socket_connection_options(%{socket_options: socket_options}) do
    # socket_options is not always a keyword list,
    # but a simple list, like it can support [:inet6, mode: :binary]
    [
      mode: :binary,
      active: false,
      packet: 0
